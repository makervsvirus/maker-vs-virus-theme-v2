        ...
        <div class="clr-col-lg-8 clr-offset-lg-2">
            ...
            <form action="/hub-registration-success" method="POST" class="clr-form">
                ...
                <div style="margin-top: .5rem; display: flex; justify-content: center; align-items: center;">
                    ...
                    <input type="text" class="clr-input" style="margin-left: 1rem; width: 100%;" id="hub_name" name="hub_name" value="<?php echo $hub_name ?>" placeholder="<?php pll_e('hub_name') ?>" />
                </div>
                ...
                <div style="margin-top: .5rem; display: flex; justify-content: center; align-items: center;">
                    ...
                    <input type="text" class="clr-input" style="margin-left: 1rem; width: 100%;" id="hub_street" name="hub_street" value="<?php echo $hub_street ?>" placeholder="<?php pll_e('hub_street') ?>" />
                </div>

                <?php $hub_zip = get_post_meta($post->ID, 'hub_zip', true); ?>
                <div style="margin-top: .5rem; display: flex; justify-content: center; align-items: center;">
                    <label class="" style="min-width: 150px;" for="hub_zip"><?php pll_e('hub_zip') ?></label>
                    <input type="text" class="clr-input" style="margin-left: 1rem; width: 100%;" id="hub_zip" name="hub_zip" value="<?php echo $hub_zip ?>" placeholder="<?php pll_e('hub_zip') ?>" />
                </div>

                <?php $hub_city = get_post_meta($post->ID, 'hub_city', true); ?>
                <div style="margin-top: .5rem; display: flex; justify-content: center; align-items: center;">
                    <label class="" style="min-width: 150px;" for="hub_city"><?php pll_e('hub_city') ?></label>
                    <input type="text" class="clr-input" style="margin-left: 1rem; width: 100%;" id="hub_city" name="hub_city" value="<?php echo $hub_city ?>" placeholder="<?php pll_e('hub_city') ?>" />
                </div>
                ...
                <div style="margin-top: .5rem; display: flex; justify-content: center; align-items: center;">
                    ...
                    <input type="text" class="clr-input" style="margin-left: 1rem; width: 100%;" id="hub_state" name="hub_state" list="hub_state_list" value="<?php echo $hub_state ?>" placeholder="<?php pll_e('hub_state') ?>" />
                </div>
                ...
                <div style="margin-top: .5rem; display: flex; justify-content: center; align-items: center;">
                    ...
                    <input type="text" class="clr-input" style="margin-left: 1rem; width: 100%;" id="hub_country" name="hub_country" value="<?php echo $hub_country ?>" placeholder="<?php pll_e('hub_country') ?>" />
                </div>
                ...
                <div style="margin-top: .5rem; display: flex; justify-content: center; align-items: center;">
                    ...
                    <input type="text" class="clr-input" style="margin-left: 1rem; width: 100%;" id="hub_contact_person" name="hub_contact_person" value="<?php echo $hub_contact_person ?>" placeholder="<?php pll_e('hub_contact_person') ?>" />
                </div>
                ...
                <div style="margin-top: .5rem; display: flex; justify-content: center; align-items: center;">
                    ...
                    <input type="email" class="clr-input" style="margin-left: 1rem; width: 100%;" id="hub_email" name="hub_email" value="<?php echo $hub_email ?>" placeholder="<?php pll_e('hub_email') ?>" />
                </div>
                ...
                <div style="margin-top: .5rem; display: flex; justify-content: center; align-items: center;">
                    ...
                    <input type="text" class="clr-input" style="margin-left: 1rem; width: 100%;" id="hub_twitter" name="hub_twitter" value="<?php echo $hub_twitter ?>" placeholder="<?php pll_e('hub_twitter') ?>" />
                </div>
                ...
                <div style="margin-top: .5rem; display: flex; justify-content: center; align-items: center;">
                    ...
                    <input type="tel" class="clr-input" style="margin-left: 1rem; width: 100%;" id="hub_phone" name="hub_phone" value="<?php echo $hub_phone ?>" placeholder="<?php pll_e('hub_phone') ?>" />
                </div>
                ...
                <div style="margin-top: .5rem; display: flex; justify-content: center; align-items: center;">
                    ...
                    <textarea class="clr-textarea" style="margin-left: 1rem; width: 100%;" id="hub_address" name="hub_address" placeholder="<?php pll_e('hub_address') ?>"><?php echo $hub_address ?></textarea>
                </div>
                ...
                <div style="margin-top: .5rem; display: flex; justify-content: center; align-items: center;">
                    ...
                    <textarea class="clr-textarea" style="margin-left: 1rem; width: 100%;" id="hub_offer" name="hub_offer" placeholder="<?php pll_e('hub_offer_details') ?>"><?php echo $hub_offer ?></textarea>
                </div>
                ...
                <div style="margin-top: .5rem; display: flex; justify-content: center; align-items: center;">
                    ...
                    <textarea class="clr-textarea" style="margin-left: 1rem; width: 100%;" id="hub_capacity" name="hub_capacity" placeholder="<?php pll_e('hub_capacity_details') ?>"><?php echo $hub_capacity ?></textarea>
                </div>
                ...
                <div style="margin-top: .5rem; display: flex; justify-content: center; align-items: center;">
                    ...
                    <textarea class="clr-textarea" style="margin-left: 1rem; width: 100%;" id="hub_description" name="hub_description" placeholder="<?php pll_e('hub_description') ?>"><?php echo $hub_description ?></textarea>
                </div>
                ...
                <div style="margin-top: 1.5rem; display: flex; justify-content: center; align-items: center;">
                    <button class="btn btn-outline" type="submit"><?php pll_e('hub_registration_send') ?></button>
                </div>
