                ...
                <div class="card-block">
                    ...
                    <form action="/hub-registration-success" method="POST" class="clr-form">
                        ...
                        <div style="margin-top: .5rem; display: flex; justify-content: center; align-items: center;">
                            ...
                            <input type="text" class="clr-input" style="margin-left: 1rem; width: 100%;" id="hub_name" name="hub_name" value="<?php echo $hub_name ?>" placeholder="<?php _e('Name des Hub') ?>" required />
                        </div>


                        <div style="margin-top: .5rem; display: flex; justify-content: center; align-items: center;">
                            <label class="" style="min-width: 150px;" for="hub_email"><?php _e('E-Mail *') ?></label>
                            <input type="email" class="clr-input" style="margin-left: 1rem; width: 100%;" id="hub_email" name="hub_email" value="<?php echo $hub_email ?>" placeholder="<?php _e('E-Mail') ?>" required />
                        </div>


                        <div style="margin-top: .5rem; display: flex; justify-content: center; align-items: center;">
                            <label class="" style="min-width: 150px;" for="hub_contact_person"><?php _e('Kontaktperson *') ?></label>
                            <input type="text" class="clr-input" style="margin-left: 1rem; width: 100%;" id="hub_contact_person" name="hub_contact_person" placeholder="<?php _e('Kontaktperson') ?>" required />
                        </div>
                        ...
                        <div style="margin-top: .5rem; display: flex; justify-content: center; align-items: center;">
                            ...
                            <input type="text" class="clr-input" style="margin-left: 1rem; width: 100%;" id="hub_city" name="hub_city" value="<?php echo $hub_city ?>" placeholder="<?php _e('Stadt') ?>" required />
                        </div>
